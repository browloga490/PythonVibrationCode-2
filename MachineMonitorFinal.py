...
graph_9 = Graph('Ch0_MISA',fill_color='honeydew')
graph_10 = Graph('Ch0_MISA',fill_color='honeydew')
graph_11 = Graph('Ch0_MISA',fill_color='honeydew')
graph_12 = Graph('Ch0_MISA',fill_color='honeydew')

graph_13 = Graph('Ch0_BEAR',fill_color='limegreen')
graph_14 = Graph('Ch0_BEAR',fill_color='limegreen')
graph_15 = Graph('Ch0_BEAR',fill_color='limegreen')
graph_16 = Graph('Ch0_BEAR',fill_color='limegreen')

graph_17 = Graph('Ch0_GEARS',fill_color='plum')
graph_18 = Graph('Ch0_GEARS',fill_color='plum')
graph_19 = Graph('Ch0_GEARS',fill_color='plum')
graph_20 = Graph('Ch0_GEARS',fill_color='plum')

graph_21 = Graph('Ch0_OTHER',fill_color='thistle')
graph_22 = Graph('Ch0_OTHER',fill_color='thistle')
graph_23 = Graph('Ch0_OTHER',fill_color='thistle')
graph_24 = Graph('Ch0_OTHER',fill_color='thistle')
